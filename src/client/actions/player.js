import { SERVER_PLAYER_DIES, SERVER_PLAYER_LOCKS_PIECE, SERVER_SEND_LINE_PENALTIES, SERVER_UPDATES_PLAYER } from "../../common/constants";
...
export const serverSendLinePenalities = nbPenalties => ({
